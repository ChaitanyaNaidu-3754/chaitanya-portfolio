...
const TechStack: React.FC = () => {
  ...
  const techStack: TechIcon[] = [
    ...
    { 
      name: "TypeScript", 
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="#3178C6" d="M3 3h18v18H3V3z"></path><path fill="#fff" d="M14.8 11.5h-2.4v9h-2v-9H8V10h6.8v1.5zm-7.95 5.55L7.4 18.6a4.3 4.3 0 001.3.7c.54.17 1.06.25 1.6.25.54 0 1.04-.07 1.5-.22a3.2 3.2 0 001.13-.64c.3-.28.54-.63.7-1.05.17-.41.25-.89.25-1.42 0-.4-.05-.77-.16-1.08-.1-.32-.26-.6-.49-.83a3.97 3.97 0 00-.88-.64 8.89 8.89 0 00-1.33-.52c-.33-.12-.6-.22-.81-.32a1.77 1.77 0 01-.51-.31.9.9 0 01-.26-.34 1.3 1.3 0 01-.08-.48c0-.17.03-.32.09-.44.06-.13.14-.23.25-.32.11-.08.24-.15.4-.2a1.98 1.98 0 011.02 0c.18.06.34.14.48.24a1.3 1.3 0 01.5.66l1.84-1.06a3.12 3.12 0 00-1.24-1.31 4.01 4.01 0 00-2.05-.47c-.52 0-1 .08-1.46.23a3.4 3.4 0 00-1.13.64 3 3 0 00-.72 1 3.2 3.2 0 00-.27 1.33c0 .54.07.99.2 1.35.14.36.34.66.6.9.26.24.56.45.92.62.35.17.75.33 1.18.46.34.11.62.21.85.32.23.1.42.2.56.32.14.1.25.22.31.35.07.13.1.29.1.46a.91.91 0 01-.35.76 1.61 1.61 0 01-1 .28 2.7 2.7 0 01-.84-.12 2.23 2.23 0 01-.67-.33 1.85 1.85 0 01-.48-.49 2.3 2.3 0 01-.27-.62z"></path></svg>`, 
      experience: "2 years" 
    },
    { 
      name: "React", 
    ...
    { 
      name: "Express", 
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="#FFFFFF" d="M24 18.588a1.529 1.529 0 0 1-1.895-.72l-3.45-4.771-.5-.667-4.003 5.444a1.466 1.466 0 0 1-1.802.708l5.158-6.92-4.798-6.251a1.595 1.595 0 0 1 1.9.666l3.576 4.83 3.596-4.81a1.435 1.435 0 0 1 1.788-.668L21.708 7.9l-2.522 3.283a.666.666 0 0 0 0 .994l4.804 6.412zM.002 11.576l.42-2.075c1.154-4.103 5.858-5.81 9.094-3.27 1.895 1.489 2.368 3.597 2.275 5.973H1.116C.943 16.447 4.005 19.009 7.92 17.7a4.078 4.078 0 0 0 2.582-2.876c.207-.666.548-.78 1.174-.588a5.417 5.417 0 0 1-2.589 3.957 6.272 6.272 0 0 1-7.306-.933 6.575 6.575 0 0 1-1.64-3.858c0-.235-.08-.455-.134-.666A88.33 88.33 0 0 1 0 11.577zm1.127-.286h9.654c-.06-3.076-2.001-5.258-4.59-5.278-2.882-.04-4.944 2.094-5.071 5.264z"></path></svg>`, 
      experience: "2 years" 
    },
    { 
      name: "MongoDB", 
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="#4DB33D" d="M17.193 9.555c-1.264-5.58-4.252-7.414-4.573-8.115-.28-.394-.53-.954-.735-1.44-.036.495-.055.685-.523 1.184-.723.566-4.438 3.682-4.74 10.02-.282 5.912 4.27 9.435 4.888 9.884l.07.05A73.49 73.49 0 0111.91 24h.481c.114-1.032.284-2.056.51-3.07.417-.296.604-.463.85-.693a11.342 11.342 0 003.639-8.464c.01-.814-.103-1.662-.197-2.218zm-5.336 8.195s0-8.291.275-8.29c.213 0 .49 10.695.49 10.695-.381-.045-.765-1.76-.765-2.405z"></path></svg>`, 
      experience: "2 years" 
    },
    { 
      name: "Firebase", 
  ...
  useEffect(() => {
    ...
    const scrollSpeed = 0.02; // Reduced for smoother scrolling
    let isHovered = false;
    ...
    const smoothScroll = () => {
      if (!isHovered && carousel) {
        ...
        // Get all the direct children and apply the transform
        const children = carousel.children;
        for (let i = 0; i < children.length; i++) {
          (children[i] as HTMLElement).style.transform = transformValue;
        }
        
        // Reset position when we've scrolled through half the items
        if (scrollPosition >= carousel.scrollWidth / 4) {
          scrollPosition = 0;
        }
      }
