...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const icons = [
      { 
        name: "HTML", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#E34F26]">
      ...
      { 
        name: "CSS", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#1572B6]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="w-8 h-8">
      ...
      { 
        name: "JavaScript", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#F7DF1E]">
      ...
      { 
        name: "React", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#61DAFB]">
      ...
      { 
        name: "Tailwind", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#38B2AC]">
      ...
      { 
        name: "Firebase", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#FFCA28]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-8 h-8">
      ...
      { 
        name: "Cloud", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#4285F4]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-8 h-8">
            <path fill="currentColor" d="M25.244 9.707l-1.049-1.05v-.003L21.272 5.73l-1.05-1.05-1.05 1.05-2.9 2.903-.008-.002L13.15 11.742l.002.008-6.954 6.954a.992.992 0 0 0 0 1.402l3.848 3.848c.2.2.45.294.696.289.246.005.497-.09.696-.29l13.806-13.805a.992.992 0 0 0 0-1.402z" fill="#ea4335"/>
            ...
            <path fill="currentColor" d="M23.155 24.627c.2.2.45.294.696.289.246.005.497-.09.696-.29l3.754-3.753a.992.992 0 0 0 0-1.402L19.4 10.54l.002-.006-2.904-2.9v.005L13.252 4.4a.992.992 0 0 0-1.403 0L8.124 8.135l1.05 1.05 2.9-2.9 1.05 1.05-1.05 1.05 1.05 1.05-1.05 1.05 1.05 1.05-1.05 1.05 1.05 1.05-1.05 1.05 1.05 1.05-2.9 2.9 2.1 2.1 2.9-2.9 1.05 1.05-1.05 1.05 4.152 4.15z" fill="#34a853"/>
      ...
      { 
        name: "Node.js", 
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#68A063]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-8 h-8">
      ...
      {
        name: "Git",
        icon: `<div class="flex items-center justify-center w-8 h-8 text-[#F05032]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-8 h-8">
            <path fill="currentColor" d="M31.396 14.575L17.425.604a2.06 2.06 0 00-2.914 0l-2.9 2.9 3.68 3.68c.856-.3 1.836-.095 2.518.587a2.45 2.45 0 01.581 2.533l3.547 3
